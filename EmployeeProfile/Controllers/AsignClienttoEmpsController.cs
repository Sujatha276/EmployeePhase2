...
namespace EmployeeProfile.Controllers
{
    public class AsignClienttoEmpsController : Controller
    {
        ...
        {
            ViewBag.EmpId = new SelectList(db.EmployeeDetails, "EmpId", "Firstname");
            return View();
        }

        // POST: AsignClienttoEmps/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Create([Bind(Include = "ID,ClientId,ClientName,EmpId,POS,POE,ClientBilling,CreatedDate,CreatedBy,ClientEmail,ClientManagerName,DesignationatClient")] AsignClienttoEmp asignClienttoEmp)
        {
            ...
            ViewBag.EmpId = new SelectList(db.EmployeeDetails, "EmpId", "Firstname", asignClienttoEmp.EmpId);
            return View(asignClienttoEmp);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,ClientId,ClientName,EmpId,POS,POE,ClientBilling,CreatedDate,CreatedBy,ClientEmail,ClientManagerName,DesignationatClient")] AsignClienttoEmp asignClienttoEmp)
        {
            if (ModelState.IsValid)
            {
